...
GoogleApps.whitelistedFields = ['id', 'email', 'verified_email', 'name', 'given_name',
                   'family_name', 'picture', 'locale', 'timezone', 'gender'];


Oauth.registerService('googleApps', 2, null, function(query) {
  ...
  var fields = _.pick(identity, GoogleApps.whitelistedFields);
...
GoogleApps.retrieveCredential = function(credentialToken) {
